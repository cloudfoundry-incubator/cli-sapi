...
var _ = Describe("purge-service-offering command", func() {
	...
	It("says OK with no errors", func() {
	...
	//
	//					Expect(fakePurgeServiceActor.PurgeServiceOfferingByNameAndBrokerCallCount()).To(Equal(0))
	//				})
	//			})
	//
	...
	//					fakePurgeServiceActor.PurgeServiceOfferingByNameAndBrokerReturns(v2action.Warnings{"warning-1"}, nil)
	//				})
	//
	//				It("purges the service offering and prints all warnings", func() {
	//					Expect(executeErr).NotTo(HaveOccurred())
	//
	//					Expect(fakePurgeServiceActor.PurgeServiceOfferingByNameAndBrokerCallCount()).To(Equal(1))
	//
	//					service := fakePurgeServiceActor.PurgeServiceOfferingByNameAndBrokerArgsForCall(0)
	...
	//						})
	//
	//						It("returns a PurgeServiceOfferingByNameAndBrokerNotFound error and prints the warnings, and OK", func() {
	...
	//						BeforeEach(func() {
	//							fakePurgeServiceActor.PurgeServiceOfferingByNameAndBrokerReturns(v2action.Warnings{"warning-1"}, fmt.Errorf("it broke!"))
	//						})
	//
